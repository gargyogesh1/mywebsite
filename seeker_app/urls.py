...
urlpatterns = [
    ...
    path('card/<unique_number>/', views.seeker_card_detail, name='seeker_card_detail'),
    path('view_job_card/<unique_number>/', views.seeker_view_job_detail, name='seeker_view_job_detail'),
