...
class Job(models.Model):
    ...
    job_qualifications = models.TextField(blank=True,null=True)
    job_preferred_skills = models.TextField(blank=True,null=True)
    job_company_culture = models.TextField(blank=True,null=True)
